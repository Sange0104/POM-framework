...
public class implusingcollectionsdeque extends logintoQueue {
	//WebDriver driver = null;
  @Test(priority = 2)
  public void Implementcollectdeque() throws InterruptedException {
	  //Click Implementation using collections.deque link
	  driver.findElement(By.xpath("//a[@href='implementation-collections']")).click();
